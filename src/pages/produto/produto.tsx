...
const Produto = () => {
  ...
  const columns: GridColDef<ProdutoDataRow>[] = [
    ...
    {field: "tipo", headerName: "Tipo", editable: false, flex: 0, minWidth: 70, width: 70, headerClassName: "gridHeader--header", valueGetter: ({ value }) => (value ? "Produto" : "Serviço"),},
    ...
    {field: "idInsumo", headerName: "Insumo", editable: false, flex: 0, minWidth: 100, width: 110, headerClassName: "gridHeader--header", renderCell: (params) => <span>{getInsumoNome(params.value)}</span>,},
