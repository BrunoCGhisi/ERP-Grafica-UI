...
import { BancoDataRow, bancoSchemaType } from "../../../shared/services/types";

import { getDeactiveBanks, putBank } from "../../../shared/services";
...
export function ModalDeactivateBanco({
  open,
  loadBanks,
  toggleModal,
